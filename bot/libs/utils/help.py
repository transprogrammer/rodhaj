        ...
        if self.index == 0:
            embed.add_field(
                ...
                value=(
                    ...
                    "the transprogrammer community. Rodhaj offers an advanced shared ticket inbox, "
                    "which allows for users and staff to seamlessly communicate safely, securely, and privately. "
                    "In addition, utilities to ease communication such as tags are available. You can get more"
                    "information on the commands offered by using the dropdown below.\n\n"
                    "Rodhaj is also open source. You can see the code on [GitHub](https://github.com/transprogrammer/rodhaj)"
                ),
                inline=False,
            )
        elif self.index == 1:
...
class RodhajHelp(commands.HelpCommand):
